                            ...
                            <div class="p-5 bg-light rounded-3 col-xl-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        type="text" name="firstName" id="firstName" value="{{ $errors->any() ? 
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        type="text" name="lastName" id="lastName" value="{{ $errors->any() ? 
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        type="text" name="email" id="email" value="{{ $errors->any() ? 
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        type="text" name="age" id="age" value="{{ $errors->any() ? 
